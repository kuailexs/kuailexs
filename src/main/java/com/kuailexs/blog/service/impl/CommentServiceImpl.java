...
import com.kuailexs.blog.modal.Bo.CommentBo;
...
public class CommentServiceImpl implements ICommentService {
    ...
    public void insertComment(CommentVo comments) {
        ...
        if (!StringUtils.hasText(comments.getAuthor())) {
            comments.setAuthor("热心网友");
        }
        if (StringUtils.hasText(comments.getMail()) && !TaleUtils.isEmail(comments.getMail())) {
